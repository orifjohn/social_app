# Generated by Django 4.0.6 on 2022-07-25 12:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('toshkent', 'toshkent'), ('samarqand', 'samarqand')], max_length=20)),
                ('status', models.CharField(choices=[('star', 'star'), ('unstar', 'unstar')], max_length=20)),
